                                    ...
                                    <Card key={log.id} className="timeline-event mb-2">
                                        <Card.Body className="p-0">
                                            ...
                                            <div className='d-flex justify-content-between align-items-start'>
                                                <div style={{ width: "80px", minWidth: "80px" }} className='text-center pt-1 pb-1 ps-1'>
                                                    <div className="timeline-icon mb-1" style={{ fontSize: '0.6rem' }}>
                                                ...
                                                <Accordion  style={{ width: "100%", borderLeft: "3px solid #e9ecef" }} flush>
