...
import { Modal, Button, Badge, ListGroup, ListGroupItem, Row, Col, Card } from 'react-bootstrap';
...
const RiskDetailModal = ({ show, onHide, risk, allUsers, displayMode = 'modal' }) => {
    if (!risk) {
        return null;
    }
    ...
    if (displayMode === 'inline') {
        return (
            <Card className="mb-3">
                <Card.Header><FaExclamationTriangle className="me-2 text-danger" />Risk Details: {risk.riskId}</Card.Header>
